...
L'objectif est de réaliser un prototype d'application permettant à un utilisateur de gérer un réseau de relations et d'effectuer des transferts d'argent entre ses contacts de manière simple et sécurisée.
...
* **Model** : représente les entités persistées en base.
...
![Diagramme_EER.PNG](../docs/Diagramme_EER.PNG)
